import { AnyRunnerFromList, ClientRunnerResolverBase, Constructor, IRunnerControllerConfig, RunnerConstructor, SoftRunnersList, RunnerIdentifier, SoftRunnerByIdentifier } from '@worker-runner/core';
...
export class RxClientRunnerResolver<L extends SoftRunnersList> extends ClientRunnerResolverBase<L> {
    ...
    ) => Promise<RxResolvedRunner<InstanceType<SoftRunnerByIdentifier<L, I>>>>;
