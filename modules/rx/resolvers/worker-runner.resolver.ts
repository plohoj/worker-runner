import { IRunnerControllerConfig, RunnerConstructor, BaseWorkerRunnerResolver } from '@worker-runner/core';
...
export class RxWorkerRunnerResolver<R extends RunnerConstructor> extends BaseWorkerRunnerResolver<R> {
