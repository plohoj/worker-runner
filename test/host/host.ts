import { DirectionConnectionIdentificationStrategyHost, MessageChannelConnectionStrategyHost, RepeatConnectionStrategyHost, WorkerConnectionHost } from '@worker-runner/core';
